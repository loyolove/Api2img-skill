...
If api2img is not configured yet, stop and ask the user to configure it first. Do not work around the missing configuration with screenshots, browser automation, HTML rendering, Puppeteer, Playwright, or similar fallback tools.

When the user asks for a real generated or edited image file, do not reinterpret that request as an HTML preview or screenshot task.
